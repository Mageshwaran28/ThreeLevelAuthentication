...
%>
    <div class="container">
        <form action="Register2Servlet" method="post" enctype="multipart/form-data">
	        <h2 align="center">Register 2</h2>
	        <label for="Image">
	        ...
	        <div class="result">
	            ...
	            <button onclick="saveImg()">Save & Upload</button>
	        </div>
        </form>
    </div>
</body>
<script>
    ...
    image_input.addEventListener("change",function(){
        ...
        reader.addEventListener("load",()=>{
            ...
            dis_img.style.backgroundImage = "url("+uploaded_image+")";
        });
